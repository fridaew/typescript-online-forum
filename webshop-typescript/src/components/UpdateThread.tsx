...
const [threadData, setThreadData] = useState({
  ...
  return (
    ...
    <div className="modal fade" id="updateeModal" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-primary" onClick={updateThread2} data-bs-dismiss='modal'>
              UPDATE <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send" viewBox="0 0 16 16">
